...
let BattlePokedex = {
	...
	charizard: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 84, def: 78, spa: 109, spd: 85, spe: 100},
		abilities: {0: "Blaze", 1: “Mountaineer”, H: "Solar Power"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
		prevo: "charmeleon",
	...
	beedrill: {
		...
		types: ["Bug", "Poison"],
		baseStats: {hp: 65, atk: 90, def: 40, spa: 45, spd: 80, spe: 75},
		abilities: {0: "Swarm", 1: “Levitate”, H: "Sniper"},
		heightm: 1,
		weightkg: 29.5,
		color: "Yellow",
		prevo: "kakuna",
	...
	psyduck: {
		...
		types: ["Water", “Psychic”],
		baseStats: {hp: 50, atk: 52, def: 48, spa: 65, spd: 50, spe: 55},
		abilities: {0: "Scrappy", 1: "Mind Break", H: "Swift Swim"},
		heightm: 0.8,
		weightkg: 19.6,
		color: "Yellow",
		evos: ["golduck"],
	...
	dragonite: {
		...
		types: ["Dragon", "Flying"],
		baseStats: {hp: 91, atk: 134, def: 95, spa: 100, spd: 100, spe: 80},
		abilities: {0: "Inner Focus", 1: “Aqua Born”, H: "Multiscale"},
		heightm: 2.2,
		weightkg: 210,
		color: "Brown",
		prevo: "dragonair",
	...
	ledian: {
		...
		types: ["Bug", "Fighting"],
		baseStats: {hp: 55, atk: 35, def: 50, spa: 55, spd: 110, spe: 85},
		abilities: {0: "Swarm", 1: "Five Star Fists", H: "Iron Fist"},
		heightm: 1.4,
		weightkg: 35.6,
		color: "Red",
		prevo: "ledyba",
	...
	unown: {
		...
		gender: "N",
		baseStats: {hp: 48, atk: 72, def: 48, spa: 72, spd: 48, spe: 48},
		abilities: {0: "Levitate", 1: “Telepathy”, H: “Power of Unown”},
		heightm: 0.5,
		weightkg: 5,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	shuckle: {
		...
		types: ["Bug", "Rock"],
		baseStats: {hp: 20, atk: 10, def: 230, spa: 10, spd: 230, spe: 5},
		abilities: {0: "Sturdy", 1: "Gluttony", H: "Juicer"},
		heightm: 0.6,
		weightkg: 20.5,
		color: "Yellow",
		eggGroups: ["Bug"],
	...
	stantler: {
		...
		types: ["Normal"],
		baseStats: {hp: 73, atk: 95, def: 62, spa: 85, spd: 65, spe: 85},
		abilities: {0: "Intimidate", 1: "Reality Bender", H: "Sap Sipper"},
		heightm: 1.4,
		weightkg: 71.2,
		color: "Brown",
		eggGroups: ["Field"],
	...
	tyranitar: {
		...
		types: ["Rock", "Dark"],
		baseStats: {hp: 100, atk: 134, def: 110, spa: 95, spd: 100, spe: 61},
		abilities: {0: "Sand Stream", 1: “Mountaineer”, H: "Unnerve"},
		heightm: 2,
		weightkg: 202,
		color: "Green",
		prevo: "pupitar",
	...
	aggron: {
		...
		types: ["Steel", "Rock"],
		baseStats: {hp: 70, atk: 110, def: 180, spa: 60, spd: 60, spe: 50},
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Mountaineer"},
		heightm: 2.1,
		weightkg: 720,
		color: "Gray",
		prevo: "lairon",
	...
	flygon: {
		...
		types: ["Ground", "Dragon"],
		baseStats: {hp: 80, atk: 100, def: 80, spa: 80, spd: 80, spe: 100},
		abilities: {0: "Levitate", 1: “Sand Stream”},
		heightm: 2,
		weightkg: 82,
		color: "Green",
		prevo: "vibrava",
	...
	cacturne: {
		...
		types: ["Grass", "Dark"],
		baseStats: {hp: 70, atk: 115, def: 60, spa: 115, spd: 60, spe: 55},
		abilities: {0: "Sand Veil", 1: “Hunter”, H: "Water Absorb"},
		heightm: 1.3,
		weightkg: 77.4,
		color: "Green",
		prevo: "cacnea",
	...
	walrein: {
		...
		types: ["Ice", "Water"],
		baseStats: {hp: 110, atk: 80, def: 90, spa: 95, spd: 90, spe: 65},
		abilities: {0: "Thick Fat", 1: "Blubber Bounce", H: "Oblivious"},
		heightm: 1.4,
		weightkg: 150.6,
		color: "Blue",
		prevo: "sealeo",
	...
	metagross: {
		...
		gender: "N",
		baseStats: {hp: 80, atk: 135, def: 130, spa: 95, spd: 90, spe: 70},
		abilities: {0: "Clear Body", 1: “Trace”, H: "Mountaineer"},
		heightm: 1.6,
		weightkg: 550,
		color: "Blue",
		prevo: "metang",
	...
	latias: {
		...
		gender: "F",
		baseStats: {hp: 80, atk: 80, def: 90, spa: 110, spd: 130, spe: 110},
		abilities: {0: "Levitate", 1: “Illusion”},
		heightm: 1.4,
		weightkg: 40,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	escavalier: {
		...
		types: ["Bug", "Steel"],
		baseStats: {hp: 70, atk: 135, def: 105, spa: 60, spd: 105, spe: 20},
		abilities: {0: "Levitate", 1: "Shell Armor", H: "Overcoat"},
		heightm: 1,
		weightkg: 33,
		color: "Gray",
		prevo: "karrablast",
	...
	landorus: {
		...
		gender: "M",
		baseStats: {hp: 89, atk: 125, def: 90, spa: 115, spd: 80, spe: 101},
		abilities: {0: "Sand Force", 1: “Harvest”, H: "Sheer Force"},
		heightm: 1.5,
		weightkg: 68,
		color: "Brown",
		eggGroups: ["Undiscovered"],
	...
	sylveon: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 95, atk: 65, def: 65, spa: 110, spd: 130, spe: 60},
		abilities: {0: "Cute Charm", 1: “Soothing Aura”, H: "Pixilate"},
		heightm: 1,
		weightkg: 23.5,
		color: "Pink",
		prevo: "eevee",
	...
	decidueye: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 107, def: 75, spa: 100, spd: 100, spe: 70},
		abilities: {0: "Overgrow", 1: “Keen Eye”, H: "Long Reach"},
		heightm: 1.6,
		weightkg: 36.6,
		color: "Brown",
		prevo: "dartrix",
	...
	golisopod: {
		...
		types: ["Bug", "Water"],
		baseStats: {hp: 75, atk: 125, def: 140, spa: 60, spd: 90, spe: 40},
		abilities: {0: "Emergency Exit", 1: “Tough Claws”, H: “Filter”},
		heightm: 2,
		weightkg: 108,
		color: "Gray",
		prevo: "wimpod",
	...
	turtonator: {
		...
		types: ["Fire", "Dragon"],
		baseStats: {hp: 60, atk: 78, def: 135, spa: 91, spd: 85, spe: 36},
		abilities: {0: "Shell Armor", 1: “Rough Skin”},
		heightm: 2,
		weightkg: 212,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	pheromosa: {
		...
		gender: "N",
		baseStats: {hp: 71, atk: 137, def: 37, spa: 137, spd: 37, spe: 151},
		abilities: {0: "Beast Boost", 1: “Long Reach”},
		heightm: 1.8,
		weightkg: 25,
		color: "White",
		eggGroups: ["Undiscovered"],
	...
	necrozma: {
		...
		gender: "N",
		baseStats: {hp: 97, atk: 107, def: 101, spa: 127, spd: 89, spe: 79},
		abilities: {0: "Light Armor", H: “Beast Boost”},
		heightm: 2.4,
		weightkg: 230,
		color: "Black",
		eggGroups: ["Undiscovered"],
